  ...
  <div class="pt-0 animate__animated animate__fadeIn">
    ...
    >
      <div class="col-span-2 xl:col-span-1 rounded-lg">
        ...
        />
        <div class="mt-10 mb-4 animate__animated animate__bounceInUp">
          <h3 class="ml-7">Category</h3>
          <BaseSelect
      ...
      <div class="col-span-2 xl:col-span-1">
        ...
        />
        <div class="mt-10 mb-4 animate__animated animate__bounceInRight">
          <h3 class="mt-10 mb-4 ml-7">Description</h3>
          <textarea
            rows="7"
